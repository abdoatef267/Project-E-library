...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    ...
    // استمع لتغييرات اسم المستخدم مباشرة من Firestore
    if (user != null) {
  ...
  void _toggleFavorite(String storyId) async {
    ...
    try {
      await _firestoreService.toggleFavorite(
          user!.uid, storyId, isCurrentlyFavorite);
      ...
      ToastHelper.showToast(
          '${AppStrings.toastFailedToUpdateFavorites}: $e',
          isError: true);
    }
  }
...
child: AddStoryPage(),duration: const Duration(milliseconds: 1300),
  ...
  onPressed: () async {
    await Navigator.push(
      ...
      PageTransition(
        type: PageTransitionType.leftToRightWithFade,
        child: SettingsPage(toggleTheme: widget.toggleTheme),
        duration: const Duration(milliseconds: 900),
        reverseDuration: const Duration(milliseconds: 900),
      ),
    );
                ...
                child: _filteredStories.isEmpty
                    ...
                    : GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final isFavorite =
                              favoriteStories.contains(story.id);
